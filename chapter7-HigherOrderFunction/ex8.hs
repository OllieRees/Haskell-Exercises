-- Transmit data with a faulty comms. channel that forgets the first bit.
-- Copying transmission data
...
faultyChannel bits = (channel . tail ) bits
...
faultyTransmit str = (decode . faultyChannel . encode) str